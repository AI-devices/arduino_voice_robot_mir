...
Вы можете воспользоваться любым удобным для вас интерфейсом на свой выбор, исходя из любых предпочтений (например, из опыта работы с ними). 
Ниже также будет размещен и описан код, для подключения i2C, можете просто взять его для упрощения. 
